...
-   *`GWmodel`*: For analyzing spatial variations in data, allowing for localized insights by modeling relationships that vary across geographic regions.
:::
...
-   **Province Boundaries**: To map various analyses onto geographic boundaries, enabling visualization of regional competitiveness patterns across the country
...
# **Prioritization Analysis for Provincial Development: Identifying Key Predictors**

# **3.0 Global Model Overview: Understanding Broad Trends Across All Provinces**
...
## Run model to Select Independent variable
...
::: callout-note
Most of the data points fall within the band for both Total Number of Projects and Total Registered Capital, indicating that they conform to the linearity assumption.
:::
...
::: callout-note
To test the normality assumption, data points should fall along the diagonal line. For the Total Number of Projects, the data points deviate from this line, indicating a potential violation of normality. However, the Total Registered Capital appears to meet the normality assumption, with most data points closely following the diagonal line.
:::
...
::: callout-note
The Total Number of Projects has one outlier, which is acceptable, as some provinces may have extremely high or low values. I would not remove it, as it could provide valuable insights. For Total Registered Capital, no outliers were found.
:::
...
::: callout-note
With the global model completed, we’ve gained insights into the overall relationship between PCI factors and FDI across all provinces as a whole. Now, by shifting to a local model, we can dive deeper to uncover unique patterns and influences within each individual province. This local approach will help us see how factors vary on a regional level, offering a more tailored perspective.
:::

<br/><br/>

# **5.0 Local Model Insights: Examining Province-Specific Influences on FDI**
...
![](images/clipboard-2913783543.png)
...
![](images/clipboard-3083308666.png)
...
![](images/clipboard-2641013902.png)
...
![](images/clipboard-1035847987.png)
...
![](images/clipboard-1710074202.png)

<br>

### 6.2.2 Visualise Coefficient Estimates

![](images/clipboard-4213000115.png)
